...
<form class="layui-form layui-form-pane" action="" id="saveForm">
  <div class="layui-form-item">
  		<label class="layui-form-label">案例标题<span>*</span></label>
  ...
  <div class="layui-form-item">
  		<label class="layui-form-label">案例简介<span>*</span></label>
	    <div class="layui-input-block">
  ...
  <div class="layui-form-item">
  		<label class="layui-form-label">案例排序</label>
	    <div class="layui-input-block">
  ...
  <div class="layui-form-item" >
	  <div class="layui-upload-list" id="lay-img">
	    ...
	    <img layer-pid="cover_img" id="cover_img" layer-src="${informationMap.cover }" src="${informationMap.cover }"  width="70px;">
  ...
  <div class="layui-form-item" >
	  <div class="layui-upload-list" style="display: flex; justify-content: flex-start;align-items: flex-end; ">
		 	...
		 	&nbsp;&nbsp;
		 	<iframe id="videoSrc" src="${informationMap.video }" height="250px" width="500px"  frameborder="0" allowfullscreen></iframe>
		 	<%-- <video id="videoSrc" controls="controls" style="height: 100px;"  src="${informationMap.video }" /> --%>
	  </div>
  </div>
   ...
   <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="video" id="video"  autocomplete="off" value="${informationMap.video }"  class="layui-input">
	    </div>
  </div>
		...
		layui.config({
		   ...
		   upload.render({
		    ...
		    form.on('submit(saveSubmit)', function(data){
				...
				webplus.doAjax('<%=basePath%>informationAccidentManage/updateInformation',data.field,'','','1')
				//阻止表单默认提交
			    return false;
		 	});
		});
