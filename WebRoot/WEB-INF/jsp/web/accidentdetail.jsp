...
<html>
	...
	<body>
		<div class="detail_content">
			<div class="detail_title">安全教育 > > 事故案例 > > 事故案例详情</div>
			...
			<div class="accident_content direction" >
				<iframe id="videoSrc" height="750" width="900"  frameborder="0"  src="${infodetail.video }" allowfullscreen></iframe>
				<%-- <video id="my-video" class="video-js  vjs-big-play-centered" controls preload="auto" width="1000" poster="${infodetail.cover }"
				 data-setup="{}">
					<source src="${infodetail.video }" type="video/mp4">
