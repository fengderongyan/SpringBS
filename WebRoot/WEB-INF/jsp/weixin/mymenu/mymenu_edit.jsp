...
<tr>
<td>错误代码说明：<a href="http://qydev.weixin.qq.com/wiki/index.php?title=全局返回码说明" target="_bank">http://qydev.weixin.qq.com/wiki/index.php?title=全局返回码说明</a>(返回错误代码说明功能正常，只是参数配置问题，具体根据错误代码看说明)</td>
</tr>
</table>
</body>
<!--提示框-->
