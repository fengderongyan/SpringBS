...
<form class="layui-form layui-form-pane" action="" id="saveForm"  autocomplete="off">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="PARENT_NAME" readonly="readonly" class="layui-input layui-disabled" value="${pds.MENU_NAME }"> 
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">菜单名称<span>*</span> </label>
    <div class="layui-input-block">
      	<input type="text" name="MENU_NAME" lay-verify="required|max:50" class="layui-input">
    </div>
  </div>
 <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      	<input type="text" name="MENU_URL" class="layui-input" 
      		<c:if test="${MENU_ID == 0}">placeholder="顶级菜单无需填写链接" readonly="readonly"</c:if>>
    </div>
 </div>
 <div class="layui-form-item">
 	<div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      	<input type="text" id="MENU_ICON" name="MENU_ICON" lay-verify="required" class="layui-input">
	    </div>
    </div>
 	<div class="layui-inline">
	    <label class="layui-form-label">序号<span>*</span> </label>
	    <div class="layui-input-inline">
	      	<input type="text" name="MENU_ORDER" lay-verify="number" class="layui-input">
	    </div>
    </div>
 </div>
  <!-- 隐藏域 -->
   <div class="layui-form-item" style="display:none;">
	...
	<script>
		layui.config({
			...
			webplus.initForm('<%=basePath%>menu/add');
