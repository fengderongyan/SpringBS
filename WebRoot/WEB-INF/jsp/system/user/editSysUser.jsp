...
<form class="layui-form layui-form-pane" action="" id="saveForm">
  <div class="layui-form-item">
  		...
  		<div class="layui-inline" style="width: 50%">
		    ...
		    <div class="layui-input-inline">
 		    	<input type="text" name="username" value="${userMap.username }" lay-verify="required"  autocomplete="off"  class="layui-input" width="100px" disabled>
		    </div>
	    </div>
  ...
  <div class="layui-form-item">
  	<div class="layui-inline" style="width: 50%">
	    ...
	    <div class="layui-input-inline" >
	    	 <input type="text" name="station" value="${userMap.station }" lay-verify="required"  autocomplete="off"  class="layui-input">
	    </div>
    </div>
    <div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	     	<select name="is_need_certificate" id="is_need_certificate" lay-verify="required" id="is_need_certificate" lay-filter="needChange">
	      		...
	      		<option value="1" <c:if test="${userMap.is_need_certificate == 1 }">selected</c:if>>是</option>
	      		<option value="0" <c:if test="${userMap.is_need_certificate == 0 }">selected</c:if>>否</option>
	      	</select>
	    </div>
    </div>
  </div>
  <div class="layui-form-item" style="display: none" id="certificate_info_div">
  	<div class="layui-inline" style="width: 50%">
	    ...
	    <div class="layui-input-inline" >
	    	 <input type="text" id="certificate_num" name="certificate_num" value="${userMap.certificate_num }" autocomplete="off"  class="layui-input">
	    </div>
    </div>
    <div class="layui-inline">
  		<label class="layui-form-label">证书名称<span>*</span></label>
	    <div class="layui-input-inline">
			<input type="text" id="certificate_name" name="certificate_name" value="${userMap.certificate_name }" autocomplete="off"  class="layui-input">
	    </div>
    </div>
  </div>
  <div class="layui-form-item" style="display: none" id="certificate_info_div2">
  	<div class="layui-inline" style="width: 50%">
	    ...
	    <div class="layui-input-inline" >
	    	<input type="text" name="certificate_begain_date" id="certificate_begain_date" value="${userMap.certificate_begain_date }" autocomplete="off" readonly="readonly" 
    ...
    <div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
			<input type="text" name="certificate_end_date" id="certificate_end_date" value="${userMap.certificate_end_date }" autocomplete="off" readonly="readonly" 
				onfocus="WdatePicker();" class="layui-input"/>
	    </div>
    </div>
  </div>
  <div class="layui-form-item" style="display:none;" id="certificate_img_div">
	  <div class="layui-upload-list">
	    ...
	    <img class="layui-upload-img" id="certificate_img"  width="70px" src="${userMap.certificate_img_url}">
	    <input type="hidden" id="certificate_img_url" name="certificate_img_url" value="${userMap.certificate_img_url}">
	    <input type="hidden" id="certificate_img_name" name="certificate_img_name" value="${userMap.certificate_img_name}">
	  </div>
  </div>
   ...
   <div class="layui-form-item" style="display:none;">
	...
	<script>
		...
		layui.config({
		    ...
		    var is_need_certificate = '${userMap.is_need_certificate}';
		    
		    needChange(is_need_certificate);
		  //选完自动上传
		   upload.render({
