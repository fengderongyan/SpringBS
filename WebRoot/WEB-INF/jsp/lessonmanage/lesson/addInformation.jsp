...
<form class="layui-form layui-form-pane" action="" id="saveForm">
  ...
  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <select name="lesson_type" id="lesson_type" lay-filter="lesson_type" lay-verify="required">
  ...
  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="radio" lay-filter="type"  id="type" name="type" value="1" title="行业"  >
	      <input type="radio" lay-filter="type"  id="type" name="type" value="2" title="园区">
	      <input type="radio" lay-filter="type"  id="type" name="type" value="3" title="企业">
	    </div>
    </div>
    <div class="layui-form-item" id="hy" style="display: none;">
  		<label class="layui-form-label">行业</label>
	    <div class="layui-input-block">
	    	<input type="text" name="text1" id="text1" readonly="readonly"
	      	  autocomplete="off"  class="layui-input">
	    	<input type="hidden" id="target_id1" name="target_id1" >
	    </div>
  </div>
  ...
  <div class="layui-form-item" id="qy" style="display: none;">
	    ...
	    <div class="layui-input-block">
	     <input type="text" name="org" id="org" readonly="readonly"
	      	autocomplete="off"  class="layui-input">
	      <input type="hidden" id="target_id3" name="target_id3">
	    </div>
  </div>
  <div class="layui-form-item" id="dz" style="display: none;">
  		<label class="layui-form-label">是否定制<span>*</span></label>
	    <div class="layui-input-block">
	      <input type="radio" lay-filter="is_public"   name="is_public" value="0" title="是"  >
	      <input type="radio" lay-filter="is_public"   name="is_public" value="1" title="否" checked="checked" >
	    </div>
    </div>
    <div class="layui-form-item">
   ...
   <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="video" id="video" readonly="readonly"  autocomplete="off"  class="layui-input">
		...
		layui.config({
		   ...
		   upload.render({
		    ...
		    form.on('submit(saveSubmit)', function(data){
				...
				webplus.doAjax('<%=basePath%>lessonmanage/lesson/saveInformation',data.field,'','','1')
				//阻止表单默认提交
			    return false;
		 	});
		});
