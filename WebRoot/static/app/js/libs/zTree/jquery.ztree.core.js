    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeDOMNodeMainBefore: function (html, setting, node) {
                html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, "' tabindex='0' hidefocus='true' treenode><div class='navigationTree_div'>");
            },
            ...
            makeUlHtml: function (setting, node, html, content) {
                html.push("</div><ul id='", node.tId, consts.id.UL, "' class='", consts.className.LEVEL, node.level, " ", view.makeUlLineClass(setting, node), "' style='display:", (node.open ? "block" : "none"), "'>");
                html.push(content);
                html.push("</ul>");
            },
