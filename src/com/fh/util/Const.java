...
public class Const {
	...
	public static final String SESSION_WXUSER = "sessionWxUser";			//session用的微信用户
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(mobile/app)|(web/index)|(myexam)|(web/personal)|(manage)|(static)|(main)|(websocket)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
	public static final String WXINTERCEPTOR_PATH = ".*/(weixin/applet).*";	//不对匹配该值的访问路径拦截（正则）--微信端
	public static final String MOBILETERCEPTOR_PATH = ".*/((checkLogin)|(editPwd)|(examFinish)).*";	//不对匹配该值的访问路径拦截（正则）--移动APP
	public static final String TOKEN_KEY_FRIST = "safe_365_";     //tokenKEy前部分
	public static final String TOKEN_KEY_END = "_info";     //tokenKEy后部分
	...
	public static final String ROLE_COUNTY = "COUNTY";//县区管理员
	public static final String ROLE_AREA = "AREA";//园区管理员
	public static final String ROLE_ORG = "ORG";//企业管理员
	public static final String ROLE_EMP = "EMP";//员工
