...
public class JPushUtil {
    ...
    private static String masterSecret = PropertiesUtil.getPropertiesValue("jpush_masterSecret");;
    
    private static String appKey = PropertiesUtil.getPropertiesValue("jpush_appKey");;
